...
def main():
    ...
    parser.add_argument('--data_list', '-i1', default='F:/data_info/TFrecord/liver/set_3/project_eigen_space/4000_norm/val.txt', help='data list')

    parser.add_argument('--num_per_tfrecord', '-i2', default=250, help='number per tfrecord')

    parser.add_argument('--outdir', '-i3', default='F:/data/tfrecord/liver/set_3/project_eigen_space/4000_norm/val', help='outdir')
